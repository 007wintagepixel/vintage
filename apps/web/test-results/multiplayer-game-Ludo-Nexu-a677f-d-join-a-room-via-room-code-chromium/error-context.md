...
- Name: multiplayer-game.spec.ts >> Ludo Nexus - Multiplayer Game Flow >> Game Room Creation & Matchmaking >> should join a room via room code
- Location: tests/multiplayer-game.spec.ts:33:9

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/room/join
Call log:
  - navigating to "http://localhost:3000/room/join", waiting until "load"
