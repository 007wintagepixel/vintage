...
- Name: e2e.spec.ts >> Ludo Nexus - Dashboard Pages (Protected) >> should load tournaments page (auth not implemented yet)
- Location: tests/e2e.spec.ts:231:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/tournaments
Call log:
  - navigating to "http://localhost:3000/tournaments", waiting until "load"
