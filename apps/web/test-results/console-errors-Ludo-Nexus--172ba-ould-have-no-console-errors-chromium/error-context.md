...
- Name: console-errors.spec.ts >> Ludo Nexus - Console Error Check >> dashboard profile page should have no console errors
- Location: tests/console-errors.spec.ts:95:7
