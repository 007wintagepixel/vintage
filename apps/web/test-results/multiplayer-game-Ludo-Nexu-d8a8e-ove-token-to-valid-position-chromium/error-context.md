...
- Name: multiplayer-game.spec.ts >> Ludo Nexus - Multiplayer Game Flow >> Game Actions - Dice Roll & Token Move >> should move token to valid position
- Location: tests/multiplayer-game.spec.ts:126:9
