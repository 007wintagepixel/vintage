...
- Name: visual-verification.spec.ts >> Ludo Nexus - Visual Verification >> should verify cyber-gaming theme classes on home page
- Location: tests/visual-verification.spec.ts:67:7
