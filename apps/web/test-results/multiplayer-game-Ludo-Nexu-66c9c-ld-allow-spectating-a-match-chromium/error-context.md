...
- Name: multiplayer-game.spec.ts >> Ludo Nexus - Multiplayer Game Flow >> Spectator Mode >> should allow spectating a match
- Location: tests/multiplayer-game.spec.ts:225:9

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/spectate/test-match-id
Call log:
  - navigating to "http://localhost:3000/spectate/test-match-id", waiting until "load"
