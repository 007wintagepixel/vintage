...
- Name: multiplayer-game.spec.ts >> Ludo Nexus - Multiplayer Game Flow >> Game Actions - Dice Roll & Token Move >> should highlight legal moves after dice roll
- Location: tests/multiplayer-game.spec.ts:111:9
