...
- Name: visual-verification.spec.ts >> Ludo Nexus - Visual Verification >> should capture register page screenshot
- Location: tests/visual-verification.spec.ts:19:7
