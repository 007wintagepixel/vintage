...
- Name: multiplayer-game.spec.ts >> Ludo Nexus - Multiplayer Game Flow >> Game Board - WebSocket Integration >> should show connection status indicator
- Location: tests/multiplayer-game.spec.ts:63:9
