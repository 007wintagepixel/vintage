...
- Name: visual-verification.spec.ts >> Ludo Nexus - Visual Verification >> should verify cyber-gaming theme classes on game modes page
- Location: tests/visual-verification.spec.ts:97:7
