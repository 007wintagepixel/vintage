...
- Name: multiplayer-game.spec.ts >> Ludo Nexus - Multiplayer Game Flow >> Game Board - WebSocket Integration >> should handle reconnection
- Location: tests/multiplayer-game.spec.ts:74:9
