...
- Name: visual-verification.spec.ts >> Ludo Nexus - Visual Verification >> should capture settings page screenshot
- Location: tests/visual-verification.spec.ts:61:7
