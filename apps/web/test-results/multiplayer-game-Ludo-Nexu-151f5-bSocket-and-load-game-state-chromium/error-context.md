...
- Name: multiplayer-game.spec.ts >> Ludo Nexus - Multiplayer Game Flow >> Game Board - WebSocket Integration >> should connect to WebSocket and load game state
- Location: tests/multiplayer-game.spec.ts:48:9
