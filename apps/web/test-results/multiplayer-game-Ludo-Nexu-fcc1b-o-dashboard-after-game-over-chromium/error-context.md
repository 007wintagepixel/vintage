...
- Name: multiplayer-game.spec.ts >> Ludo Nexus - Multiplayer Game Flow >> Game Completion >> should navigate to dashboard after game over
- Location: tests/multiplayer-game.spec.ts:203:9
