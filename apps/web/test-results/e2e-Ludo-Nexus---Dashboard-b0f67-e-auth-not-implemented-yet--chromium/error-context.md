...
- Name: e2e.spec.ts >> Ludo Nexus - Dashboard Pages (Protected) >> should load friends page (auth not implemented yet)
- Location: tests/e2e.spec.ts:226:7
...
Call log:
  - navigating to "http://localhost:3000/friends", waiting until "load"
