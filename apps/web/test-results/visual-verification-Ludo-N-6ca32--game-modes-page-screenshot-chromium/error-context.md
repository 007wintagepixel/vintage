...
- Name: visual-verification.spec.ts >> Ludo Nexus - Visual Verification >> should capture game modes page screenshot
- Location: tests/visual-verification.spec.ts:25:7
