...
- Name: multiplayer-game.spec.ts >> Ludo Nexus - Multiplayer Game Flow >> Game Actions - Dice Roll & Token Move >> should roll dice when it's player's turn
- Location: tests/multiplayer-game.spec.ts:95:9
