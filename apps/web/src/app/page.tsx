...
import { 
  Dice1, Users, Trophy, Zap, Shield, 
  Play, ArrowRight, Star, Target,
  Brain, Globe, Smartphone, Monitor
} from 'lucide-react';
    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 glass-panel-strong border-b border-surface-border mx-4 mt-4 rounded-xl max-w-7xl">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            <Link href="#features" className="text-text-secondary hover:text-text-primary transition-colors text-body-sm font-medium">Features</Link>
            <Link href="#game-modes" className="text-text-secondary hover:text-text-primary transition-colors text-body-sm font-medium">Game Modes</Link>
            <Link href="#tech" className="text-text-secondary hover:text-text-primary transition-colors text-body-sm font-medium">Technology</Link>
          </div>
        ...
        <div className="max-w-7xl w-full">
          <div className="text-center animate-in">
            ...
            >
              ...
              <span className="text-body-sm text-text-secondary">Version 1.0 • Demo Mode Active</span>
            </motion.div>
            ...
            >
              ...
              Real-time multiplayer, AI opponents, tournaments, and a premium wallet system — all in one stunning platform.
            </motion.p>
            ...
            >
              <Link href="/register" className="btn-primary px-10 py-4 text-body-lg group">
                <Play className="w-5 h-5" />
                <span>Start Playing Free</span>
                <ArrowRight className="w-5 h-5 transition-transform group-hover:translate-x-1" />
              </Link>
              <Link href="#game-modes" className="btn-secondary px-10 py-4 text-body-lg">
                Explore Game Modes
              </Link>
            </motion.div>
      ...
      <section id="features" className="py-24 px-4 relative">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <span className="text-body-sm text-primary-glow font-medium uppercase tracking-wider">Features</span>
            <h2 className="font-display text-display-md mt-2 mb-4 gradient-text">Built for Champions</h2>
            <p className="text-body-lg text-text-secondary max-w-2xl mx-auto">
              Every feature crafted for competitive play, stunning visuals, and seamless experience.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((feature, index) => (
              ...
              >
                ...
                <h3 className="font-display text-heading-md mb-3">{feature.title}</h3>
                <p className="text-text-secondary text-body mb-4">{feature.description}</p>
                <ul className="space-y-2">
                  {feature.details.map((detail, i) => (
                    <li key={i} className="flex items-center gap-2 text-body-sm text-text-muted">
      ...
      <section id="game-modes" className="py-24 px-4 relative">
        <div className="max-w-7xl mx-auto">
          <motion.div 
            ...
            className="text-center mb-16"
          >
            <span className="text-body-sm text-secondary-glow font-medium uppercase tracking-wider">Game Modes</span>
            <h2 className="font-display text-display-md mt-2 mb-4 gradient-text-gold">Choose Your Battle</h2>
            <p className="text-body-lg text-text-secondary max-w-2xl mx-auto">
              From casual AI practice to high-stakes tournaments — find your perfect match.
            </p>
          </motion.div>
            ...
            {gameModes.map((mode, index) => (
              ...
              >
                ...
                <div className="relative p-8 h-full flex flex-col">
                  ...
                  <h3 className="font-display text-heading-lg text-center mb-2">{mode.title}</h3>
                  <p className="text-text-secondary text-center text-body mb-6 flex-1">{mode.description}</p>
      ...
      <section id="tech" className="py-24 px-4 relative">
        <div className="max-w-7xl mx-auto">
          <motion.div 
            ...
            className="text-center mb-16"
          >
            <span className="text-body-sm text-accent-cyan font-medium uppercase tracking-wider">Technology</span>
            <h2 className="font-display text-display-md mt-2 mb-4 gradient-text">Engineered for Excellence</h2>
            <p className="text-body-lg text-text-secondary max-w-2xl mx-auto">
              Modern stack, real-time architecture, and server-authoritative game logic.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {techStack.map((tech, index) => (
              ...
              >
                ...
                <h3 className="font-display text-heading-sm mb-2">{tech.title}</h3>
                <p className="text-text-secondary text-body-sm">{tech.description}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="py-24 px-4 relative">
        <div className="max-w-4xl mx-auto text-center">
          <motion.div className="glass-panel-strong p-12 md:p-16 rounded-3xl relative overflow-hidden">
            ...
            >
              <h2 className="font-display text-display-md mb-4 gradient-text">Ready to Play?</h2>
              <p className="text-body-lg text-text-secondary mb-8 max-w-xl mx-auto">
                Join thousands of players in the most advanced Ludo experience ever built. 
                Free to play, forever fair.
              </p>
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                ...
                <Link href="#game-modes" className="btn-ghost px-10 py-4 text-body-lg border border-surface-borderGlow">
                  Learn More
                </Link>
              </div>
            </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
            <div>
              <Link href="/" className="flex items-center gap-3 mb-4">
                ...
                <span className="font-display text-heading-md gradient-text">Ludo Nexus</span>
              </Link>
              <p className="text-text-muted text-body-sm">
                Futuristic Ludo gaming platform with real-time multiplayer, tournaments, and AI opponents.
              </p>
            </div>
            <div>
              <h4 className="font-medium text-text-primary mb-4">Game</h4>
              <ul className="space-y-2 text-body-sm text-text-secondary">
                <li><Link href="/game-modes/vs-ai" className="hover:text-primary-glow transition-colors">vs AI</Link></li>
                <li><Link href="/game-modes/vs-human" className="hover:text-primary-glow transition-colors">vs Human</Link></li>
                <li><Link href="/game-modes/tournament" className="hover:text-primary-glow transition-colors">Tournaments</Link></li>
                <li><Link href="/game-modes/team" className="hover:text-primary-glow transition-colors">Team Match</Link></li>
              </ul>
            </div>
            <div>
              <h4 className="font-medium text-text-primary mb-4">Resources</h4>
              <ul className="space-y-2 text-body-sm text-text-secondary">
                <li><Link href="/help" className="hover:text-primary-glow transition-colors">Help Center</Link></li>
                <li><Link href="/terms" className="hover:text-primary-glow transition-colors">Terms of Service</Link></li>
                <li><Link href="/privacy" className="hover:text-primary-glow transition-colors">Privacy Policy</Link></li>
                <li><Link href="/responsible-gaming" className="hover:text-primary-glow transition-colors">Responsible Gaming</Link></li>
              </ul>
            </div>
            <div>
              <h4 className="font-medium text-text-primary mb-4">Legal</h4>
              <p className="text-body-sm text-text-muted mb-4">
                Demo mode only. No real money gambling. 
                All balances shown as "Demo Coins".
              </p>
...
const features = [
  {
    ...
    icon: Users,
    description: 'Play instantly with friends or matchmake globally with sub-100ms latency.',
    details: [
  ...
  },
  {
    ...
    icon: Brain,
    description: 'Three difficulty levels with human-like decision making and strategy.',
    details: [
  ...
  },
  {
    ...
    icon: Trophy,
    description: 'Knockout & scheduled tournaments with brackets, prizes, and leaderboards.',
    details: [
  ...
  },
  {
    ...
    icon: Shield,
    description: 'Demo coin system with double-entry ledger, deposits, withdrawals & audit trail.',
    details: [
  ...
  },
  {
    ...
    icon: Smartphone,
    description: 'Installable on mobile, tablet, desktop — same experience everywhere.',
    details: [
...
const techStack = [
  {
    ...
    icon: Monitor,
    description: 'App Router, Server Components, and edge-ready for global performance.',
  },
  {
    title: 'NestJS + TypeScript',
    icon: Brain,
    description: 'Modular backend with dependency injection, WebSockets, and type safety.',
  },
  {
    title: 'PostgreSQL + Prisma',
    icon: Shield,
    description: 'ACID-compliant database with type-safe ORM and migration system.',
  },
  {
    title: 'Socket.IO + Redis',
    icon: Zap,
    description: 'Real-time multiplayer with horizontal scaling and pub/sub architecture.',
  },
];
