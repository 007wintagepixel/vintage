    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          ...
          {
            label: "Active Now",
            value: mockMatches.filter((m) => m.status === "active").length,
            icon: Play,
            color: "text-accent-green",
          },
          {
            label: "Flagged",
            value: mockMatches.filter((m) => m.status === "flagged").length,
            icon: Flag,
            color: "text-secondary-glow",
          },
          {
            label: "Cancelled",
            value: mockMatches.filter((m) => m.status === "cancelled").length,
            icon: Ban,
                    ...
                    <div className="flex items-center justify-end gap-2">
                      ...
                      {match.status !== "flagged" &&
                        match.status !== "cancelled" && (
                          <button
                            className="p-2 rounded-lg text-text-muted hover:text-secondary-glow hover:bg-secondary-glow/10 transition-all"
