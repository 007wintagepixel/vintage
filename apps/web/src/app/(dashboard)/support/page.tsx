...
const faqs = [
  {
    ...
    answer:
      "Tap on a token to select it, then tap the dice to roll. The selected token will move automatically based on the dice value. You need a 6 to move a token out of the starting area. Landing on an opponent's token sends them back to start.",
  },
  {
    id: "2",
    category: "Account",
    ...
    answer:
      "Go to Settings > Profile to update your username. For password changes, go to Settings > Security. You'll need to verify your email before the change takes effect. Usernames can only be changed once every 30 days.",
  },
  {
    id: "3",
    category: "Wallet",
    ...
    answer:
      'Navigate to the Wallet page and click "Deposit" to add coins via supported payment methods. For withdrawals, click "Withdraw" and enter your preferred payout method. Withdrawals are processed within 24-48 hours and may require KYC verification for large amounts.',
  },
  {
    id: "4",
    ...
    answer:
      'Browse available tournaments on the Tournaments page. Click "Register" and pay the entry fee if applicable. You must check in before the tournament starts. Prize pools are distributed based on your final placement. Tournament winnings are credited to your wallet within 1 hour of completion.',
  },
  {
    id: "5",
    category: "Fair Play",
    ...
    answer:
      "We take fair play seriously. If a player disconnects mid-game, the match continues and the disconnected player forfeits their turns. Repeated disconnections may result in penalties. Report cheating via the in-game report button or through this support page. Our team reviews all reports within 48 hours.",
  },
  {
    id: "6",
    category: "Technical",
    ...
    answer:
      "Try refreshing the page first. If the issue persists, clear your browser cache and cookies, then restart your browser. Ensure you have a stable internet connection. If problems continue, try a different browser or device. You can also report the issue using the contact form below with details about your device and browser.",
  },
];
...
const mockTickets = [
  {
    id: "TK-4821",
    subject: "Unable to withdraw coins",
    status: "open",
    priority: "high",
    created: "2 days ago",
  ...
  {
    id: "TK-4755",
    subject: "Friend request not showing",
    status: "resolved",
    priority: "low",
    created: "1 week ago",
    ...
    <div className="space-y-8">
      ...
      >
        ...
        <p className="text-text-secondary mt-1">
          Get help, find answers, and contact our team
        </p>
      </motion.div>
              ...
              >
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="text-caption text-text-muted mb-0.5">
                      {faq.category}
                    </div>
              ...
              return (
                ...
                >
                  <div className="flex items-start justify-between gap-4 mb-2">
                    ...
                    <span
                      className={`px-2.5 py-1 rounded-full text-caption font-medium ${status.bg} ${status.color} flex-shrink-0`}
                    >
                      {status.label}
                    </span>
                  </div>
      ...
      <motion.div
        ...
        className="glass-card-strong rounded-2xl p-6"
      >
        <h2 className="font-display text-heading-md text-text-primary mb-4">
          Policies & Resources
        </h2>
