...
export default function DashboardMatchesPage() {
  ...
  const [sortBy, setSortBy] = useState<"date" | "earnings" | "duration">(
    "date",
  );
    ...
    <div className="space-y-8">
      ...
      >
        <div>
          ...
          <p className="text-text-secondary mt-1">
            View your past games, replays, and statistics
          </p>
        </div>
      ...
      >
        {[
          ...
          {
            label: "Wins",
            value: mockMatches.filter((m) => m.result === "won").length,
            icon: Trophy,
            color: "text-accent-green",
          },
          {
            label: "Win Rate",
            value: `${Math.round((mockMatches.filter((m) => m.result === "won").length / mockMatches.length) * 100)}%`,
            icon: Target,
        ...
        {paginatedMatches.length === 0 ? (
          <div className="glass-card-strong p-12 rounded-2xl text-center">
            ...
            <p className="text-text-secondary text-body">
              Try adjusting your filters or play your first game!
            </p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-4 items-center">
                      ...
                      <div className="md:col-span-2 flex items-center gap-3">
                        ...
                        <div>
                          <div className="font-medium text-text-primary">
                            {modeLabels[
                              match.mode as keyof typeof modeLabels
                            ] || match.mode}
                          </div>
                      ...
                      <div className="md:col-span-3 flex items-center justify-center md:justify-end gap-3">
                        <motion.div
                          ...
                          className={`font-display text-heading-sm font-mono ${earningsColorClass}`}
                        >
                          {earningsDisplay}
                        </motion.div>
                      </div>
