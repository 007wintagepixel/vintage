...
const mockMessages: Record<string, Message[]> = {
  global: [
    {
      ...
      avatar: "P2",
      content: "Anyone up for a quick match?",
      timestamp: "10:30 AM",
      isMe: false,
    },
    {
    ...
    },
    {
      id: "4",
      senderId: "p4",
      senderName: "PlayerFour",
      avatar: "P4",
      content: "What's the entry fee?",
      timestamp: "10:33 AM",
      isMe: false,
    },
    {
      ...
      senderName: "You",
      avatar: "P1",
      content: "100 coins, classic mode",
      timestamp: "10:33 AM",
      isMe: true,
    },
    {
      ...
      senderName: "PlayerTwo",
      avatar: "P2",
      content: "Perfect, sending the code now",
      timestamp: "10:34 AM",
      isMe: false,
    },
  ],
  p2: [
    ...
    },
    {
      ...
      senderName: "You",
      avatar: "P1",
      content: "Yeah! That last roll was clutch",
      timestamp: "10:26 AM",
      isMe: true,
    },
    {
      ...
      senderName: "PlayerTwo",
      avatar: "P2",
      content: "I almost had you with the capture",
      timestamp: "10:27 AM",
      isMe: false,
    },
    {
      ...
      senderName: "You",
      avatar: "P1",
      content: "Lucky I rolled a 6 to escape 😅",
      timestamp: "10:28 AM",
      isMe: true,
    },
  ],
...
export default function ChatPage() {
  ...
  const tabs: {
  ...
  }[] = [
    {
      ...
      label: "Global",
      icon: Globe,
      count: conversationsByTab.global.reduce((a, c) => a + c.unread, 0),
    },
    {
      id: "friends",
      label: "Friends",
      icon: Users,
      count: conversationsByTab.friends.reduce((a, c) => a + c.unread, 0),
    },
    {
      id: "match",
      label: "Match",
      icon: Swords,
      count: conversationsByTab.match.reduce((a, c) => a + c.unread, 0),
    },
  ];
      ...
      >
        <div>
          ...
          <p className="text-text-secondary mt-1">
            Stay connected with players and friends
          </p>
        </div>
      </motion.div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-medium text-text-primary flex items-center gap-2">
                    {currentConversation?.type === "global" && (
                  ...
                  <div className="text-caption text-text-muted flex items-center gap-1">
                    <Circle
                      className={`w-2 h-2 ${currentConversation?.online ? "text-accent-green fill-current" : "text-text-muted fill-current"}`}
                    />
            ...
            <div className="flex-1 overflow-y-auto scrollbar-thin p-4 space-y-4">
              {currentMessages.map((msg, index) => (
                ...
                >
                  ...
                  >
                    {!msg.isMe && (
                      <span className="text-caption text-text-muted mb-1 px-1">
                        {msg.senderName}
                      </span>
                    )}
                    <div
                    ...
                    <span className="text-caption text-text-muted mt-1 px-1">
                      {msg.timestamp}
                    </span>
                  </div>
                </motion.div>
