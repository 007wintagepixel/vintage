...
export class ChatGateway implements OnGatewayConnection, OnGatewayDisconnect {
  ...
  handleTypingStart(
    ...
    client.to(`conversation:${data.conversationId}`).emit('user_typing', { userId });
  }
  ...
  handleTypingStop(
    ...
    client.to(`conversation:${data.conversationId}`).emit('user_stopped_typing', { userId });
  }
  ...
  async handleSendGlobal(
    ...
    try {
      ...
      const message = await this.chatService.sendGlobalMessage(userId, data.content);
